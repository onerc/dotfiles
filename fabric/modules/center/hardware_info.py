...
class HardwareInfo(Box):
    def __init__(self):
        for label in [
            ...
            setattr(
                self, label, Label(label="N/A", h_expand=True, name="hardwareLabel")
            )
        ...
        self.cache_label = Label(h_expand=True, name="cacheLabel")

        self.network_label = Label(h_expand=True, name="revealerLabel")
